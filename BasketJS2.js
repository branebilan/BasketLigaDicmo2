...
export function teamstatsOne() {
  let playerOne = [player1.points_average, player1.assists_average, player1.rebounds_average, player1.blocks_average, player1.stolen_average, player1.shots_hit_average, `${player1.shots_hit}┃${player1.shots_missed}`, `${player1.freethrows_hit}┃${player1.freethrows_missed}`];
  for (let i = 0; i < playerOne.length; i++){
    const element = document.querySelector('.element-01' + i);
    element.append(playerOne[i]);
  }

  let playerTwo = [player2.points_average, player2.assists_average, player2.rebounds_average, player2.blocks_average, player2.stolen_average, player2.shots_hit_average, `${player2.shots_hit}┃${player2.shots_missed}`, `${player2.freethrows_hit}┃${player2.freethrows_missed}`];
  for (let i = 0; i < playerTwo.length; i++){
    const element = document.querySelector('.element-02' + i);
    element.append(playerTwo[i]);
  }

  let playerThree = [player3.points_average, player3.assists_average, player3.rebounds_average, player3.blocks_average, player3.stolen_average, player3.shots_hit_average, `${player3.shots_hit}┃${player3.shots_missed}`, `${player3.freethrows_hit}┃${player3.freethrows_missed}`];
  for (let i = 0; i < playerThree.length; i++){
    const element = document.querySelector('.element-03' + i);
    element.append(playerThree[i]);
  }

  let playerFive = [player5.points_average, player5.assists_average, player5.rebounds_average, player5.blocks_average, player5.stolen_average, player5.shots_hit_average, `${player5.shots_hit}┃${player5.shots_missed}`, `${player5.freethrows_hit}┃${player5.freethrows_missed}`];
...
export function teamstatsTwo() {
  let playerSix = [player6.points_average, player6.assists_average, player6.rebounds_average, player6.blocks_average, player6.stolen_average, player6.shots_hit_average, `${player6.shots_hit}┃${player6.shots_missed}`, `${player6.freethrows_hit}┃${player6.freethrows_missed}`];
  for (let i = 0; i < playerSix.length; i++){
    const element = document.querySelector('.element-06' + i);
    element.append(playerSix[i]);
  }

  let playerSeven = [player7.points_average, player7.assists_average, player7.rebounds_average, player7.blocks_average, player7.stolen_average, player7.shots_hit_average, `${player7.shots_hit}┃${player7.shots_missed}`, `${player7.freethrows_hit}┃${player7.freethrows_missed}`];
  for (let i = 0; i < playerSeven.length; i++){
    const element = document.querySelector('.element-07' + i);
    element.append(playerSeven[i]);
  }

  let playerEight = [player8.points_average, player8.assists_average, player8.rebounds_average, player8.blocks_average, player8.stolen_average, player8.shots_hit_average, `${player8.shots_hit}┃${player8.shots_missed}`, `${player8.freethrows_hit}┃${player8.freethrows_missed}`];
...
export function teamstatsThree() {
  let playerNine = [player9.points_average, player9.assists_average, player9.rebounds_average, player9.blocks_average, player9.stolen_average, player9.shots_hit_average, `${player9.shots_hit}┃${player9.shots_missed}`, `${player9.freethrows_hit}┃${player9.freethrows_missed}`];
  for (let i = 0; i < playerNine.length; i++){
    const element = document.querySelector('.element-09' + i);
    element.append(playerNine[i]);
  }

  let playerTen = [player10.points_average, player10.assists_average, player10.rebounds_average, player10.blocks_average, player10.stolen_average, player10.shots_hit_average, `${player10.shots_hit}┃${player10.shots_missed}`, `${player7.freethrows_hit}┃${player10.freethrows_missed}`];
  for (let i = 0; i < playerTen.length; i++){
    const element = document.querySelector('.element-10' + i);
    element.append(playerTen[i]);
  }

  let playerEleven = [player11.points_average, player11.assists_average, player11.rebounds_average, player11.blocks_average, player11.stolen_average, player11.shots_hit_average, `${player11.shots_hit}┃${player11.shots_missed}`, `${player11.freethrows_hit}┃${player11.freethrows_missed}`];
  for (let i = 0; i < playerEleven.length; i++){
    const element = document.querySelector('.element-11' + i);
    element.append(playerEleven[i]);
  }

  let playerThirteen = [player13.points_average, player13.assists_average, player13.rebounds_average, player13.blocks_average, player13.stolen_average, player13.shots_hit_average, `${player13.shots_hit}┃${player13.shots_missed}`, `${player13.freethrows_hit}┃${player13.freethrows_missed}`];
...
export function teamstatsFour() {
  let playerFourteen = [player14.points_average, player14.assists_average, player14.rebounds_average, player14.blocks_average, player14.stolen_average, player14.shots_hit_average, `${player14.shots_hit}┃${player14.shots_missed}`, `${player14.freethrows_hit}┃${player14.freethrows_missed}`];
  for (let i = 0; i < playerFourteen.length; i++){
    const element = document.querySelector('.element-14' + i);
    element.append(playerFourteen[i]);
  }

  let playerTwelve = [player12.points_average, player12.assists_average, player12.rebounds_average, player12.blocks_average, player12.stolen_average, player12.shots_hit_average, `${player12.shots_hit}┃${player12.shots_missed}`, `${player12.freethrows_hit}┃${player12.freethrows_missed}`];
  for (let i = 0; i < playerTwelve.length; i++){
    const element = document.querySelector('.element-12' + i);
    element.append(playerTwelve[i]);
  }

  let playerFifteen = [player15.points_average, player15.assists_average, player15.rebounds_average, player15.blocks_average, player15.stolen_average, player15.shots_hit_average, `${player15.shots_hit}┃${player15.shots_missed}`, `${player15.freethrows_hit}┃${player15.freethrows_missed}`];
...
export function teamstatsFive() {
  let playerSixteen = [player16.points_average, player16.assists_average, player16.rebounds_average, player16.blocks_average, player16.stolen_average, player16.shots_hit_average, `${player16.shots_hit}┃${player16.shots_missed}`, `${player16.freethrows_hit}┃${player16.freethrows_missed}`];
  for (let i = 0; i < playerSixteen.length; i++){
    const element = document.querySelector('.element-16' + i);
    element.append(playerSixteen[i]);
  }

  let playerSeventeen = [player17.points_average, player17.assists_average, player17.rebounds_average, player17.blocks_average, player17.stolen_average, player17.shots_hit_average, `${player17.shots_hit}┃${player17.shots_missed}`, `${player17.freethrows_hit}┃${player17.freethrows_missed}`];
  for (let i = 0; i < playerSeventeen.length; i++){
    const element = document.querySelector('.element-17' + i);
    element.append(playerSeventeen[i]);
  }

  let playerEighteen = [player18.points_average, player18.assists_average, player18.rebounds_average, player18.blocks_average, player18.stolen_average, player18.shots_hit_average, `${player18.shots_hit}┃${player18.shots_missed}`, `${player18.freethrows_hit}┃${player18.freethrows_missed}`];
  for (let i = 0; i < playerEighteen.length; i++){
    const element = document.querySelector('.element-18' + i);
    element.append(playerEighteen[i]);
  }
  
  let playerNineteen = [player19.points_average, player19.assists_average, player19.rebounds_average, player19.blocks_average, player19.stolen_average, player19.shots_hit_average, `${player19.shots_hit}┃${player19.shots_missed}`, `${player19.freethrows_hit}┃${player19.freethrows_missed}`];
...
export function teamstatsSix() {
  let playerTwenty = [player20.points_average, player20.assists_average, player20.rebounds_average, player20.blocks_average, player20.stolen_average, player20.shots_hit_average, `${player20.shots_hit}┃${player20.shots_missed}`, `${player20.freethrows_hit}┃${player20.freethrows_missed}`];
  for (let i = 0; i < playerTwenty.length; i++){
    const element = document.querySelector('.element-20' + i);
    element.append(playerTwenty[i]);
  }

  let playerTwentyone = [player21.points_average, player21.assists_average, player21.rebounds_average, player21.blocks_average, player21.stolen_average, player21.shots_hit_average, `${player21.shots_hit}┃${player21.shots_missed}`, `${player21.freethrows_hit}┃${player21.freethrows_missed}`];
  for (let i = 0; i < playerTwentyone.length; i++){
    const element = document.querySelector('.element-21' + i);
    element.append(playerTwentyone[i]);
  }

  let playerTwentytwo = [player22.points_average, player22.assists_average, player22.rebounds_average, player22.blocks_average, player22.stolen_average, player22.shots_hit_average, `${player22.shots_hit}┃${player22.shots_missed}`, `${player22.freethrows_hit}┃${player22.freethrows_missed}`];
